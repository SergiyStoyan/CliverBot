...
namespace Cliver.CrawlerHost
{
    public class DbApi
    {
        ...
        static internal readonly DbConnection Dbc = DbConnection.Create(Settings.Default.DbConnectionString);
...
_last_product_time datetime)"
        ...
        internal static string GetProductsTableForCrawler(string crawler_id)
        {
