...
//                    Log.Exit("Cannot initiate curl");

//                if (WR.BTC != null)
//                    CookieFile = Log.SessionDir + "\\" + "cookies_" + WR.BTC.Id.ToString() + ".txt";
//                else
//                    CookieFile = Log.SessionDir + "\\" + "cookies" + ".txt";
//            }
//            catch (Exception e)
//            {
//                Log.Exit(e);
...
//                }
//                else if (rc == CURLcode.CURLE_WRITE_ERROR)
//                {
//                    if (attempt_count >= Config.Proxy.MaxAttemptCountWithNewProxy)
//                    {
//                        Log.Error("Attempt quota exeeded: " + attempt_count.ToString());
...
//            try
//            {
//                if (WR.UseCache && Cache.GetCachedFile(url, null, out WR.HtmlResult, out WR.BinaryResult, out WR.ResponseUrl))
//                {
...
//                    easy.SetOpt(CURLoption.CURLOPT_PROXYAUTH, CURLhttpAuth.CURLAUTH_ANY);
//                    WR.show_proxy(proxy.Ip + ":" + proxy.Port);
//                }
...
//                    Log.Error("Download error: " + WR.ErrorMessage + "\nURL:" + url + "\nPROXY: " + proxy.Ip + ":" + proxy.Port + "\nCURLcode:" + rc);
//                    return rc;
//                }
...
//                Log.CacheDownloadedString(url, null, WR.ResponseUrl, WR.HtmlResult, WR.page_number++, WR.CycleIdentifier, WR.web_routine_status);
...
//                    WR.show_progress(content_length, received_length);
...
//                            Log.Write("Unacceptable Content-Type:" + m.Result("$1"));
//                        }
//                        return size * nmemb;
//                    }
//                }
